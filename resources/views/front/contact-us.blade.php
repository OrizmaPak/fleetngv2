...
<body>
    <!-- Navbar Area Start -->
    <nav class="nav-main postion-sticky top-0" style="background-color: #EFF2F4;">
        <div class="container common-container">
            <div class="navbar-inner-div">
                <div class="left-div"> <a href="{{ url('/') }}"><img
    ...
    <!-- Navbar Area End -->
    <div class="container col-md-10 offset-md-1 col-xl-8 offset-xl-2 py-5">
        <h1 class="text-center fw-700 mb-0">Let's Connect</h1>
        <hr class="mt-1">
        <div class="row pt-4 pb-5">
            <div class="col-md-6">
                <div class="contact-info">
                    ...
                    <div class="pt-4">
                        <img src="{{ asset('front/images/icons/address.svg') }}" alt="FleetNG Address" width="30"
                            class="mb-2 img-fluid">
                        <p><strong>Address:</strong> <br> Suite 6, Scapular Plaza KM 17 Lekki-Epe expressway Eti-Osa
                            Lagos Nigeria</p> <br>

                        <img src="{{ asset('front/images/icons/call.svg') }}" alt="Call FleetNG" width="30"
                            class="mb-2 img-fluid">
                        <p><strong>Phone:</strong> <br> <a class="black-clr text-decoration-none"
                                href="tel: +234-906-493-7788">+234 906 493 7788</a></p> <br>

                        <img src="{{ asset('front/images/icons/mail.svg') }}" alt="Send mail to FleetNG" width="30"
                            class="mb-2 img-fluid">
                        <p><strong>Email:</strong> <br> <a class="black-clr text-decoration-none"
                                href="mailto: support@fleetng.com">support@fleetng.com</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-5 mt-md-0">
                <div class="contact-form">
                    <h2>Get in Touch</h2>
                    <div class="alert alert-danger alert-dismissible fade show mt-2" role="alert" id="alertDiv"
                        style="display: none">
                        <strong id="alertMessage"></strong>
                        <button type="button" class="btn-close" aria-label="Close" onclick="hideError()"></button>
                    </div>
                    <div class="alert alert-success alert-dismissible fade show mt-2" role="alert" id="successDiv"
                        style="display: none">
                    ...
                    <form action="javascript:void(0)" method="POST">
                        ...
                        <div class="pt-3">
                            <input type="submit" class="btn btn-primary py-8 fs-18 mb-0" value="Submit">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script src="{{ asset('front/js/jquery.inputmask.min.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $.validator.addMethod('customphone', function(value, element) {
            return this.optional(element) || /^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/.test(
                value);
        ...
        var validator = $('form').validate({
            ...
            messages: {
                phone: {
                    ...
                    customphone: 'Please enter a valid number.'
                },
                name: {
                ...
                email: {
                    ...
                    emailExt: "Please enter valid email."
                },
            },
            ...
            $.ajax({
                ...
                success: (response) => {
                    ...
                    $('#successMessage').text(response.message ||
                        "Thank you for connecting. We'll get to back to you shortly.");
                },
                error: (error) => {
                    $("#loader-div").hide();
                    $('#alertMessage').text(error.responseJSON ? error.responseJSON.message :
