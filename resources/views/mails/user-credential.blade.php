...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; opacity: 1; background-color: #eceff1; background-color: rgba(236, 239, 241, 1);">
    <div style="display: none;">fleetNG User Account</div>
              ...
              <tr>
                <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                  <a href="javascript:void(0);">
                    <img src="{{asset('images/logo/fleetng-logo.svg')}}" width="70" alt="Logo" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                  </a>
                </td>
              </tr>
              <tr>
                  ...
                  <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, 1); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; opacity: 1; color: #626262; color: rgba(98, 98, 98, 1);" bgcolor="rgba(255, 255, 255, 1)" align="left">
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Hello, {{$merchant_name}}</p>
                        {{-- <p style="font-weight: 700; font-size: 20px; margin-top: 0; opacity: 1; color: #ff5850; color: rgba(255, 88, 80, 1);">{{$user_name}}!</p> --}}
                        <p style="margin: 0 2 24px;">
                          We have successfully created your fleetNG Merchant Account.
                        </p>
                        ...
                        <p style="margin: 0 0 24px;">Use following link to access your merchant account- </p>
                        ...
                        {{-- <p style="margin: 24px 0;">
                          <span style="font-weight: 600;">Note:</span> If you haven't changed your password, please contact the Site Administrator.
                        </p> --}}
                      <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                    ...
                    <tr>
                      <td style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 12px; padding-left: 48px; padding-right: 48px; opacity: 1; color: #eceff1; color: rgba(236, 239, 241, 1);">
                        <p align="center" style="cursor: default; margin-bottom: 16px;">
                          <a href="https://www.facebook.com" style="opacity: 1; color: #263238; color: rgba(38, 50, 56, 1); text-decoration: none;"><img src="{{asset('images/facebook.png')}}" width="17" alt="Facebook" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                          &bull;
                          <a href="https://twitter.com" style="opacity: 1; color: #263238; color: rgba(38, 50, 56, 1); text-decoration: none;"><img src="{{asset('images/twitter.png')}}" width="17" alt="Twitter" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                          &bull;
                          <a href="https://www.instagram.com" style="opacity: 1; color: #263238; color: rgba(38, 50, 56, 1); text-decoration: none;"><img src="{{asset('images/instagram.png')}}" width="17" alt="Instagram" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                        </p>
