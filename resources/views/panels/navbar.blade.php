...
@endif
<div class="navbar-container d-flex justify-content-between content px-0">
        ...
        <li class="nav-item dropdown dropdown-user">
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                ...
                <div class="user-nav d-sm-flex d-none">
                    ...
                    {{-- <span class="user-status">Hi, {{Auth()->user()->full_name}}</span> --}}
                </div>
                <span class="avatar">
                    <img class="round"
                        src="{{ auth()->user()->photo ? auth()->user()->photo : asset('images/avatars/user-image.png') }}"
