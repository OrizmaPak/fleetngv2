...
<section id="ajax-datatable">
  ...
  <div class="row"> 
    <div class="col-12">
      <div class="card">
        <div class="card-header gap-1 border-bottom">
          <h4 class="card-title">Merchant List</h4>
          <input type="text" id="search_user" placeholder="Search Merchant" onkeyup="newUser();" class="form-control" style="width: 200px;">
          <input type="text" id="search_email" placeholder="Search Email" onkeyup="newUser();" class="form-control" style="width: 175px;">
          ...
          <br><br><br>
          <a href="{{ route('add-merchant') }}" class="btn btn-success waves-effect waves-float waves-light"><i data-feather='plus'></i>&nbsp;Add New Merchant</a>
        </div>

        <div class="card-datatable table table-responsive">
          <table class="datatables-ajax table" id="merchantList">
            <thead>
              <tr>
                <!-- <th>id</th> -->
                <th>Merchant Code</th>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#merchantList').DataTable({
      ...
      "bLengthChange": false,
      "ajax": {
        "url": "{{ route('merchant-list-detail') }}"
  ...
  function newUser() {
        ...
        $('#merchantList').DataTable({
          ...
          "bLengthChange": false,
          "ajax": {
            "url": "{{ route('merchant-list-detail-filter') }}",
            data: {
