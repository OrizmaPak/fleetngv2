    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">View Merchant</h4>
              ...
              <div class="col-12">
                ...
                <div class="col-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" id="merchant_name" class="form-control" name="merchant_name" placeholder="Merchant Name*" value="{{$user_details['merchant_name']}}" required=""  readonly="" />
                    </div>                   
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" id="merchant_address" class="form-control" name="merchant_address" placeholder="Merchant Address*" value="{{$user_details['merchant_address']}}" required=""  readonly="" />
                    </div>                   
                  </div>
                </div>
                <div class="col-12">
