...
@section('title', 'Edit Payment User')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">Edit Payment User</h4>
          <a href="{{ route('payment-user-list') }}" class="btn btn-outline-dark mr-1"><i data-feather='chevron-left'></i> Back</a>
        </div>
        @if(Session::get('fail'))
        ...
        <br>
        <div class="card-body">
          <form class="form form-horizontal" method="POST" action="{{ route('edit-payment-user',$user_details['id']) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-12">
                <div class="col-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" id="last_name" class="form-control" name="last_name" placeholder="Last Name" value="{{$user_details['last_name']}}" />
                    </div>
                  </div>
                </div>
                <div class="col-12">
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="merchant" id="merchant" required>
                     ...
                     @foreach($merchant_details as $merchant)
                      <option value="{{ $merchant['id'] }}" {{$merchant['id'] == $user_details['merchant_assigned']  ? 'selected' : ''}}> {{ $merchant['merchant_id'] }} - {{ $merchant['merchant_name'] }}</option>
                      @endforeach
                      @endif
                    </select>
                ...
                <div class="col-sm-9 offset-sm-3">
                  ...
                  <a href="{{ route('payment-user-list') }}" class="btn btn-danger mr-1">Cancel</a>
                </div>
              </div>
          </form>
        </div>
...
<script type="text/javascript">
    ...
    $('#superadmin_payment_user_list').addClass('active');
