    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <input type="text" id="search_user" placeholder="Search User" onkeyup="newUser();" class="form-control" style="width: 150px;">
          <input type="text" id="search_email" placeholder="Search Email" onkeyup="newUser();" class="form-control" style="width: 150px;">
          <input type="text" id="search_phone" placeholder="Search Phone" onkeyup="newUser();" class="form-control" style="width: 150px;">
          <select class="form-control" id="user_type" style="width: 150px;" onchange="newUser();">
            <option value="all">All Payment Users</option>
            <option value="1">Active</option>
            <option value="0">Inactive</option>
          </select>
          <a href="{{ route('add-payment-user-page') }}" class="btn btn-success waves-effect waves-float waves-light"><i data-feather='plus'></i>&nbsp;Add New user</a>
        </div>
...
<div class="modal fade text-left" id="deleteSliderConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('payment-user-delete') }}" method="post">
        @csrf
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#userList').DataTable({
      ...
      "bLengthChange": false,
      "ajax": {
        "url": "{{ route('payment-user-list-detail') }}"
  ...
  function newUser() {
        ...
        $('#userList').DataTable({
          ...
          "bLengthChange": false,
          "ajax": {
            "url": "{{ route('payment-user-list-detail-filter') }}",
            data: {
