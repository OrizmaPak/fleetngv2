...
@section('title', 'View Payment User')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">View Payment User</h4>
              ...
              <div class="col-12">
                <div class="col-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <img src="@if(@getimagesize($user_details['photo'])){{$user_details['photo']}}@else {{asset('images/user_default.png')}} @endif"height="100"> 
                    </div>
                  </div>
                </div>
                <div class="col-12">
