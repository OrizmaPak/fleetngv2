  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <br>
        <div class="card-body">
          <form class="form form-horizontal" method="POST" action="{{ route('edit-user',$user_details['id']) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-12">
                <div class="col-12">
                ...
                <!-- <div class="col-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <img src="{{$user_details['photo']}}" height="100"> <br><br>
                      <input type="file" name="photo" id="profile_image" class="form-control" onchange="preview_image(this)">
                    </div>
                  </div>
                </div> -->
                <!-- <div class="col-12">
