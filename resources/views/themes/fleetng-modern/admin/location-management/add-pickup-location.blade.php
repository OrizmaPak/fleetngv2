    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">Add Pickup Location</h4>
        ...
        <br>
        <div class="card-body">
          <form class="form form-horizontal" method="POST" action="{{ route('add-pickup-location') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-12">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <input class="form-control" type="text" name="location_name" value="" placeholder="Enter address name" autocomplete="off" required><br>
                      <input class="form-control" id="pac-input" type="text" name="location" parsley-trigger="change" value="{{(isset($_POST['address']))?$_POST['address']:''}}" placeholder="Enter address" autocomplete="off" required>
                    </div>
                  </div>
                </div>
                <div class="col-12">
