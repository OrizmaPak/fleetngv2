                                ...
                                @if (Auth::user()->user_type === 1)
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="merchant_name" class="form-control"
                                                    name="merchant_name"value="{{ $user_details['merchant_name'] }}"
                                                    required="" readonly="" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="email" class="form-control" name="email"
                                                placeholder="Email ID" value="{{ $user_details['email'] }}" required=""
                                                readonly="" />
                                        </div>
                                    </div>
                                </div>
